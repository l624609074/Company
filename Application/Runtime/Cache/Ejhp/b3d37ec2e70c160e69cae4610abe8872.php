...
<div class="m-1000">
  <div class="list_title">
    <h2>补血资讯</h2>
    <a href="javascript:void(0)" onclick="openZoosUrl();LR_HideInvite();return false;" rel="nofollow" class="fr">在线咨询</a> </div>
  <div class="list_centent">
    <div class="place"><span>当前位置：</span><a href="/ejhp/Index/Index#">首页</a>&nbsp;>&nbsp;<a href="">补血资讯</a></div>
    <div class="list_ul">
      <ul>
		<?php if(is_array($data)): foreach($data as $key=>$vo): ?><li><a href="/ejhp/News/Detail/id/<?php echo ($vo["id"]); ?>" title="<?php echo ($vo["title"]); ?>" target="_blank"><?php echo ($vo["title"]); ?></a><span><?php echo (date("Y-d-m",$vo["pushtime"])); ?></span></li><?php endforeach; endif; ?>
      </ul>
      <div class="both"></div>
    </div>
    <div class="page">
