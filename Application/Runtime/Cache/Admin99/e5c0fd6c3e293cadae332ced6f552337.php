	...
	<div class="mid">
		<form id="form1" name="form1" method="post" action="/admin99/Login/doLogin" style="width:266px; height:335px;">
		  <label>
			...
			<div class="block">
			<input type="text" name="verify" style="height:45px; width:105px; border:0px; position:relative; top:-20px; font-size:18px; color:#666; background:none; font:'微软雅黑' #666;"/><img src="/admin99/Verify/getVerifyCode"  style=" width:95px; height:45px; padding-left:10px;cursor:pointer;border:0px" id="verifyImg" />
			<br />
			<input type="submit" style="border:0px;background:none; text-indent:99999px; margin-top:28px;  width:266px; height:34px; cursor:pointer;position:relative;top:-22px;margin-left:-50px" />
		  </label>
        </form>
	  </div>
</div>
