...
$(function(){
		$("#changeCode").on("click",function(){
				var mySrc="/home/Verify/getVerifyCode?"+Math.random();
...
function phpsys_update_code(a){
	a.src="/home/Verify/getVerifyCode?"+Math.random();
}

/* 表单判断 */
function mycheck(){

	var val=$('option:selected').attr('class');
	$("#price").val(val);
...
$(document).ready(function() {
	...
	initComplexArea('prov', 'cityselect', 'dist', area_array, sub_array, '0', '0', '0');
      ...
      <form method="post" action="/home/SubOrder/submit"  style="width:528px; height:500px; margin:0 auto; _margin-left:316px;" onsubmit="return mycheck()" name="form1">
        <label>
          <select name="productid" id="productid" style="width:264px; height:26px; font-size:12px; color:#a30c1f;">
            <?php if(is_array($data)): foreach($data as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>" style="color:#000000;" class="<?php echo ($vo["price"]); ?>"><?php echo ($vo["productname"]); ?>  ￥<?php echo ($vo["price"]); ?></option><?php endforeach; endif; ?>
          </select>
        </label>
        <label>
        ...
        <label>
          <input type="text" name="phone" id="phone" value="" style="width:260px; height:26px; background:none; border:0px; margin-left:4px; margin-top:30px; _margin-top:26px;" />
        </label>
		<div class="city">
        ...
        <label>
          ...
          <span id="phpsys_update_code" ><img src="/home/Verify/getVerifyCode" border="0" align="absmiddle" style="width:100px;height:28px;" style="cursor:pointer;" onclick="phpsys_update_code(this)" id="codeImg" > <a style="color:white" href="javascript:void();" id="changeCode" >看不清?</a> </span> </label>
        <br />
        <label>
...
<div class="footer"> <a href="/home/Index/Test/Flag/ContactUs">联系我们</a>|
    <a href="/home/Index/Test/Flag/AboutUs">关于我们</a>|
     <a href="/home/Index/Test/Flag/Company">公司简介</a><br/>Copyright &copy; 深圳市石岩镇水田第三工业区民营路4号201 &nbsp;2011-2015 版权所有 翻版必究 &nbsp;&nbsp;&nbsp; <?php echo ($ICP); ?>  电话：0755-29684314 29683115</div>
